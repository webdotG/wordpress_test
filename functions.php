...
$content .= 'всем спасибо. все свободны';
      // .= -- служит знаком +плюс добавляет к контенту парамаетр переменной $content
      //  = -- служит знаком =равно и в таком случае мы бы заменили весь контент на парамаетр переменной $content
return $content;
}
